...
| [FAZ1-WP03](./FAZ1-WP03-COKLU-MOTOR-ADAPTORLERI.md) | 3 | codex/gemini/opencode/aider adaptörleri + kurulum | 12–16 sa | P0 | WP-02 | 6 adaptör registry'de; mock-CLI testleri |
...
| [FAZ1-WP05](./FAZ1-WP05-WORKTREE-OTOMASYONU.md) | 5 | Worktree otomasyonu + `.env.local` + silme seçenekleri | 8 sa | P0 | WP-01, WP-06 | Repo köküne düşme yok; port offset |
| [FAZ1-WP06](./FAZ1-WP06-REPO-SECICI-VE-SETTINGS.md) | 6 | Repo seçici + settings kalıcılığı | 4 sa | P0 | WP-01 | Dialog seçimi kalıcı; açılışta hatırlanıyor |
